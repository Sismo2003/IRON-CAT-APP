...
<head>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Order Overview')); ?>
    ...
    <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
        ...
        <?php include 'partials/page-wrapper.php'; ?>
            ...
            <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Ecommerce', 'title' => 'Order Overview')); ?>
                                            ...
                                            <tr>
                                                <td class="px-3.5 py-4 border-b border-dashed first:pl-0 last:pr-0 border-slate-200 dark:border-zink-500">
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div class="grow">
                                                            <h6 class="mb-1 text-15"><a href="apps-ecommerce-product-overview.php" class="transition-all duration-300 ease-linear hover:text-custom-500">Roar Twill Blue Baseball Cap</a></h6>
                                            ...
                                            <tr>
                                                <td class="px-3.5 py-4 border-b border-dashed first:pl-0 last:pr-0 border-slate-200 dark:border-zink-500">
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div class="grow">
                                                            <h6 class="mb-1 text-15"><a href="apps-ecommerce-product-overview.php" class="transition-all duration-300 ease-linear hover:text-custom-500">Mesh Ergonomic Green Chair</a></h6>
                                            ...
                                            <tr>
                                                <td class="px-3.5 py-4 border-b border-dashed first:pl-0 last:pr-0 border-slate-200 dark:border-zink-500">
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div class="grow">
                                                            <h6 class="mb-1 text-15"><a href="apps-ecommerce-product-overview.php" class="transition-all duration-300 ease-linear hover:text-custom-500">Smartest Printed T-shirt</a></h6>
                                    ...
                                    <table class="w-full">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="px-3.5 first:pl-0 last:pr-0 py-2 border-y border-transparent"><a href="apps-invoice-overview.php" class="text-custom-500">#TWI154203</a></td>
                                            </tr>
                                            <tr>
