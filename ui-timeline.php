    ...
    <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
        ...
        <?php include 'partials/page-wrapper.php'; ?>
            ...
            <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'UI Elements', 'title' => 'Timeline')); ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div class="relative ltr:pl-6 rtl:pr-6 after:absolute after:w-2 after:h-2 after:bg-custom-500 after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div class="relative ltr:pl-6 rtl:pr-6 after:absolute after:w-2 after:h-2 after:bg-custom-500 after:rounded-sm ltr:after:left-0 rtl:after:right-0 after:top-1.5">
                                    <h6 class="mb-4 text-15">Interview Done</h6>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div class="relative ltr:pl-6 rtl:pr-6 after:absolute after:w-2 after:h-2 after:bg-white after:border after:border-slate-200 after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5 dark:after:bg-zink-700 dark:after:border-zink-500">
                                    <h6 class="mb-4 text-15">Interview Done</h6>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div class="relative ltr:pl-6 rtl:pr-6 after:absolute after:w-2 after:h-2 after:bg-white after:border-slate-200 after:border after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5 dark:after:bg-zink-700 dark:after:border-zink-500">
                                    <h6 class="mb-4 text-15">Interview Done</h6>
                                </div>
                            </div>
                        </div>
