...
<head>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Social Media')); ?>
                    ...
                    <div class="col-span-12 lg:col-span-7 xl:col-span-9 2xl:col-span-6">
                                ...
                                <div class="w-full" data-simplebar>
                                    <div class="flex gap-4">
                                        <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active" data-glightbox="max-width: 28rem;">
                                            <div class="w-16 h-16 mx-auto rounded-full bg-pink-100 dark:bg-pink-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                                <img src="assets/images/users/avatar-1.png" alt="" class="w-16 h-16 rounded-full">
                                                <div class="absolute flex items-center justify-center w-5 h-5 text-white rounded-full ltr:-right-0.5 rtl:-left-0.5 -bottom-0.5 bg-sky-500">
                                        ...
                                        <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active" data-glightbox="max-width: 28rem;">
                                            <div class="w-16 h-16 mx-auto rounded-full bg-sky-100 dark:bg-sky-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                                <img src="assets/images/users/avatar-2.png" alt="" class="w-16 h-16 rounded-full">
                                            </div>
                                            <h6 class="mt-2 font-normal truncate"> @zaria_muller</h6>
                                        </a>

                                        <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active" data-glightbox="max-width: 28rem;">
                                            <div class="w-16 h-16 mx-auto rounded-full bg-slate-100 dark:bg-zink-600 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                                <img src="assets/images/users/avatar-3.png" alt="" class="w-16 h-16 rounded-full">
                                            </div>
                                            <h6 class="mt-2 font-normal truncate"> @christina</h6>
                                        </a>

                                        <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active" data-glightbox="max-width: 28rem;">
                                            <div class="w-16 h-16 mx-auto rounded-full bg-yellow-100 dark:bg-yellow-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                                <img src="assets/images/users/avatar-4.png" alt="" class="w-16 h-16 rounded-full">
                                            </div>
                                            <h6 class="mt-2 font-normal truncate"> @blaze_herzog</h6>
                                        </a>
                                        <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active" data-glightbox="max-width: 28rem;">
                                            <div class="w-16 h-16 mx-auto rounded-full bg-emerald-100 dark:bg-emerald-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                                <img src="assets/images/users/avatar-5.png" alt="" class="w-16 h-16 rounded-full">
                                            </div>
                                            <h6 class="mt-2 font-normal truncate">@keon_rippin</h6>
                                        </a>
                                        <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active" data-glightbox="max-width: 28rem;">
                                            <div class="w-16 h-16 mx-auto rounded-full bg-purple-100 dark:bg-purple-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                                <img src="assets/images/users/avatar-6.png" alt="" class="w-16 h-16 rounded-full">
                                            </div>
                                        ...
                                        <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story" data-glightbox="max-width: 28rem;">
                                            <div class="w-16 h-16 mx-auto rounded-full bg-custom-100 dark:bg-custom-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                                <img src="assets/images/users/avatar-7.png" alt="" class="w-16 h-16 rounded-full">
                                            </div>
                                            <h6 class="mt-2 font-normal truncate">@genesis</h6>
                                        </a>
                                        <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story" data-glightbox="max-width: 28rem;">
                                            <div class="w-16 h-16 mx-auto rounded-full bg-green-100 dark:bg-green-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                                <img src="assets/images/users/avatar-8.png" alt="" class="w-16 h-16 rounded-full">
                                            </div>
                                            <h6 class="mt-2 font-normal truncate">@brayan_herman</h6>
                                        </a>
                                        <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story" data-glightbox="max-width: 28rem;">
                                            <div class="w-16 h-16 mx-auto rounded-full bg-purple-100 dark:bg-purple-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                                <img src="assets/images/users/avatar-9.png" alt="" class="w-16 h-16 rounded-full">
                                            </div>
                                            <h6 class="mt-2 font-normal truncate">@logan</h6>
                                        </a>
                                        <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story" data-glightbox="max-width: 28rem;">
                                            <div class="w-16 h-16 mx-auto rounded-full bg-cyan-100 dark:bg-cyan-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                                <img src="assets/images/users/avatar-10.png" alt="" class="w-16 h-16 rounded-full">
                                            </div>
                                        ...
                                        <a href="#!" class="block w-20 px-1 py-2 group">
                                            <div class="w-16 h-16 mx-auto rounded-full bg-slate-100 dark:bg-zink-600 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700">
                                                <img src="assets/images/users/avatar-3.png" alt="" class="w-16 h-16 rounded-full">
                                            </div>
                                            <h6 class="mt-2 font-normal truncate">@christina</h6>
                                        </a>
                                ...
                                <form action="#!">
                                    <div class="flex gap-3 mt-4">
                                        <div class="bg-pink-100 rounded-full h-9 w-9 shrink-0 dark:bg-pink-500/20">
                                            <img src="assets/images/users/avatar-1.png" alt="" class="rounded-full w-9 h-9">
                                        </div>
                                        <div class="grow">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="flex flex-wrap items-center gap-3 mb-5">
                                    <div class="w-12 h-12 bg-green-100 rounded-full outline-1 outline outline-transparent outline-offset-[3px] [&.active]:outline-custom-500 shrink-0 dark:bg-green-500/20">
                                        <img src="assets/images/users/avatar-8.png" alt="" class="w-12 h-12 rounded-full">
                                    </div>
                                    <div class="grow">
                                ...
                                <div class="mt-5">
                                    <div class="flex gap-3">
                                        <div class="bg-yellow-100 rounded-full h-9 w-9 shrink-0 dark:bg-yellow-500/20">
                                            <img src="assets/images/users/avatar-5.png" alt="" class="rounded-full w-9 h-9">
                                        </div>
                                        <div class="grow">
                                            ...
                                            <div class="flex gap-3 mt-4">
                                                <div class="bg-green-100 rounded-full h-9 w-9 shrink-0 dark:bg-green-500/20">
                                                    <img src="assets/images/users/avatar-8.png" alt="" class="rounded-full w-9 h-9">
                                                </div>
                                                <div class="grow">
                                                    <div class="p-3 rounded-md bg-slate-100 dark:bg-zink-600">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="flex flex-wrap items-center gap-3 mb-5">
                                    <div class="w-12 h-12 bg-green-100 rounded-full outline-1 outline outline-transparent outline-offset-[3px] [&.active]:outline-custom-500 shrink-0 dark:bg-green=500/20">
                                        <img src="assets/images/users/avatar-7.png" alt="" class="w-12 h-12 rounded-full">
                                    </div>
                                    <div class="grow">
...
<div id="inline-example" class="max-h-[600px] !p-3.5 bg-white rounded-md bg-cover bg-no-repeat relative bg-[url('https://cdn.dribbble.com/userupload/3012253/file/original-dd6cf163ea8f5617304d9d41f6ff38e7.png?resize=1024x768')]" style="display: none">
    ...
    <div class="relative flex flex-col h-full inline-inner">
        ...
        <div class="flex items-center gap-3 mb-5">
            <div class="w-12 h-12 bg-green-100 rounded-full outline-1 outline outline-transparent outline-offset-[3px] [&.active]:outline-custom-500 shrink-0">
                <img src="assets/images/users/avatar-8.png" alt="" class="w-12 h-12 rounded-full">
            </div>
            <div class="grow">
...
<div id="imagesVideoPostModal" modal-center class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show">
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600 flex flex-col h-full">
        <div class="flex items-center justify-between p-4 border-b dark:border-zink-500">
            ...
            <button data-modal-close="imagesVideoPostModal" class="transition-all duration-200 ease-linear text-slate-500 dark:text-zink-200 hover:text-red-500 dark:hover:text-red-500"><i data-lucide="x" class="w-5 h-5"></i></button>
        </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center justify-center bg-white border border-dashed rounded-md cursor-pointer dropzone border-slate-300 dropzone2 dark:bg-zink-700 dark:border-zink-500">
                        ...
                        <div class="w-full py-5 text-lg text-center dz-message needsclick">
                            <div class="mb-3">
                                <i data-lucide="upload-cloud" class="block w-12 h-12 mx-auto text-slate-500 fill-slate-200 dark:text-zink-200 dark:fill-zink-600"></i>
                            </div>
...
<div id="eventModal" modal-center class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show">
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600 flex flex-col h-full">
        <div class="flex items-center justify-between p-4 border-b dark:border-zink-500">
            ...
            <button data-modal-close="eventModal" class="transition-all duration-200 ease-linear text-slate-500 dark:text-zink-200 hover:text-red-500 dark:hover:text-red-500"><i data-lucide="x" class="w-5 h-5"></i></button>
        </div>
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
            <form action="#!">
                <div class="mb-4">
