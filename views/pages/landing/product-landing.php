                    ...
                    <div class="swiper-slide">
                        <div class="p-5 text-center" data-aos="fade-up" data-aos-easing="linear">
                            <div class="w-20 h-20 mx-auto rounded-full bg-custom-500/10">
                                <img src="assets/images/users/avatar-2.png" alt="" class="w-20 h-20 rounded-full">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="p-5 text-center" data-aos="fade-up" data-aos-easing="linear">
                            <div class="w-20 h-20 mx-auto rounded-full bg-yellow-500/10">
                                <img src="assets/images/users/avatar-4.png" alt="" class="w-20 h-20 rounded-full">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="p-5 text-center" data-aos="fade-up" data-aos-easing="linear">
                            <div class="w-20 h-20 mx-auto rounded-full bg-red-500/10">
                                <img src="assets/images/users/avatar-7.png" alt="" class="w-20 h-20 rounded-full">
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="p-5 text-center" data-aos="fade-up" data-aos-easing="linear">
                                <div class="w-20 h-20 mx-auto rounded-full bg-purple-500/10">
                                    <img src="assets/images/users/avatar-9.png" alt="" class="w-20 h-20 rounded-full">
                                </div>
