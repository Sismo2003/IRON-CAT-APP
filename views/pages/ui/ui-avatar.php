...
<head>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Avatar')); ?>
    ...
    <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
        ...
        <?php include 'partials/page-wrapper.php'; ?>
            ...
            <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'UI Elements', 'title' => 'Avatar')); ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="flex flex-wrap items-center gap-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <span class="absolute w-3.5 h-3.5 bg-green-400 border-2 border-white rounded-full -top-1.5 ltr:-right-1.5 rtl:-left-1.5 dark:border-zink-700"></span>
                                    </div>
                                    <div class="relative">
                            ...
                            <div class="card-body">
                                ...
                                <div class="flex flex-wrap items-center gap-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <span class="absolute w-3.5 h-3.5 bg-green-400 border-2 border-white rounded-full top-0.5 ltr:right-0.5 rtl:left-0.5 dark:border-zink-700"></span>
                                    </div>
                                    <div class="relative">
                            ...
                            <div class="card-body">
                                ...
                                <div class="flex flex-wrap items-center gap-4">
                                    ...
                                    <div class="relative flex items-center justify-center size-16 text-xl rounded-md bg-custom-100 dark:bg-custom-950 text-custom-500">
                                        A
                                        <span class="absolute w-3.5 h-3.5 bg-red-400 border-2 border-white rounded-full dark:border-zink-700 -top-1.5 ltr:-right-1.5 rtl:-left-1.5"></span>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="flex flex-wrap items-center gap-4">
                                    ...
                                    <div class="relative flex items-center justify-center size-16 text-xl rounded-full bg-custom-100 text-custom-500 dark:bg-custom-950">
                                        A <span class="absolute w-3.5 h-3.5 bg-red-400 border-2 border-white rounded-full top-0.5 ltr:right-0.5 rtl:left-0.5 dark:border-zink-700"></span>
                                    </div>
