...
<head>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Grid View')); ?>
    ...
    <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
        ...
        <?php include 'partials/page-wrapper.php'; ?>
            ...
            <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Users', 'title' => 'Grid View')); ?>
                ...
                <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="relative flex items-center justify-center mx-auto text-lg rounded-full size-16 bg-slate-100 dark:bg-zink-600">
                                <img src="assets/images/users/avatar-1.png" alt="" class="rounded-full size-16">
                            ...
                            <div class="mt-4 text-center">
                                <h5 class="mb-1 text-16"><a href="pages-account.php">Paula Keenan</a></h5>
                            ...
                            <div class="flex gap-2 mt-5">
                                ...
                                <div class="relative dropdown">
                                    ...
                                    <ul class="absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600" aria-labelledby="userGridDropdown12">
                                        <li>
                                            <a class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200" href="pages-account.php"><i data-lucide="eye" class="inline-block size-3 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Overview</span></a>
                                        </li>
                                        <li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="relative flex items-center justify-center mx-auto text-lg rounded-full size-16 bg-slate-100 dark:bg-zink-600">
                                <img src="assets/images/users/avatar-2.png" alt="" class="rounded-full size-16">
                                <span class="absolute bg-green-400 border-2 border-white rounded-full size-3 dark:border-zink-700 bottom-1 ltr:right-1 rtl:left-1"></span>
                            </div>
                            <div class="mt-4 text-center">
                                <h5 class="mb-1 text-16"><a href="pages-account.php">Marie Prohaska</a></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="relative flex items-center justify-center mx-auto text-lg rounded-full size-16 bg-slate-100 dark:bg-zink-600">
                                <img src="assets/images/users/avatar-3.png" alt="" class="rounded-full size-16">
                                <span class="absolute bg-green-400 border-2 border-white rounded-full size-3 dark:border-zink-700 bottom-1 ltr:right-1 rtl:left-1"></span>
                            </div>
                            <div class="mt-4 text-center">
                                <h5 class="mb-1 text-16"><a href="pages-account.php">Jaqueline Hammes</a></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-center">
                                <h5 class="mb-1 text-16"><a href="pages-account.php">Angus Bergstrom</a></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="relative flex items-center justify-center mx-auto text-lg rounded-full size-16 bg-slate-100 dark:bg-zink-600">
                                <img src="assets/images/users/avatar-4.png" alt="" class="rounded-full size-16">
                                <span class="absolute bg-red-400 border-2 border-white rounded-full size-3 dark:border-zink-500 bottom-1 right-1"></span>
                            </div>
                            <div class="mt-4 text-center">
                                <h5 class="mb-1 text-16"><a href="pages-account.php">Aurore Maggio</a></h5>
                                <p class="mb-3 text-slate-500 dark:text-zink-200">@Subscriber</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-center">
                                <h5 class="mb-1 text-16"><a href="pages-account.php">Andrea Pesina</a></h5>
                                <p class="mb-3 text-slate-500 dark:text-zink-200">@Editor</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="relative flex items-center justify-center mx-auto text-lg rounded-full size-16 bg-slate-100 dark:bg-zink-600">
                                <img src="assets/images/users/avatar-5.png" alt="" class="rounded-full size-16">
                                <span class="absolute bg-red-400 border-2 border-white rounded-full size-3 dark:border-zink-500 bottom-1 right-1"></span>
                            </div>
                            <div class="mt-4 text-center">
                                <h5 class="mb-1 text-16"><a href="pages-account.php">Daniel Miller</a></h5>
                                <p class="mb-3 text-slate-500 dark:text-zink-200">@Subscriber</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="relative flex items-center justify-center mx-auto text-lg rounded-full size-16 bg-slate-100 dark:bg-zink-600">
                                <img src="assets/images/users/avatar-6.png" alt="" class="rounded-full size-16">
                                <span class="absolute bg-green-400 border-2 border-white rounded-full size-3 dark:border-zink-700 bottom-1 ltr:right-1 rtl:left-1"></span>
                            </div>
                            <div class="mt-4 text-center">
                                <h5 class="mb-1 text-16"><a href="pages-account.php">Ashley Wilson</a></h5>
                                <p class="mb-3 text-slate-500 dark:text-zink-200">@Subscriber</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="relative flex items-center justify-center mx-auto text-lg rounded-full size-16 bg-slate-100 dark:bg-zink-600">
                                <img src="assets/images/users/avatar-7.png" alt="" class="rounded-full size-16">
                                <span class="absolute bg-green-400 border-2 border-white rounded-full size-3 dark:border-zink-700 bottom-1 ltr:right-1 rtl:left-1"></span>
                            </div>
                            <div class="mt-4 text-center">
                                <h5 class="mb-1 text-16"><a href="pages-account.php">William Heineman</a></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="relative flex items-center justify-center mx-auto text-lg rounded-full size-16 bg-slate-100 dark:bg-zink-600">
                                <img src="assets/images/users/avatar-8.png" alt="" class="rounded-full size-16">
                                <span class="absolute bg-green-400 border-2 border-white rounded-full size-3 dark:border-zink-700 bottom-1 ltr:right-1 rtl:left-1"></span>
                            </div>
                            <div class="mt-4 text-center">
                                <h5 class="mb-1 text-16"><a href="pages-account.php">Kara Miller</a></h5>
                                <p class="mb-3 text-slate-500 dark:text-zink-200">@Subscriber</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-center">
                                <h5 class="mb-1 text-16"><a href="pages-account.php">Mark Walton</a></h5>
                                <p class="mb-3 text-slate-500 dark:text-zink-200">@Author</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-center">
                                <h5 class="mb-1 text-16"><a href="pages-account.php">David Biggs</a></h5>
                                <p class="mb-3 text-slate-500 dark:text-zink-200">@Subscriber</p>
