...
<head>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Event')); ?>
    ...
    <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
        ...
        <?php include 'partials/page-wrapper.php'; ?>
            ...
            <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Social Media', 'title' => 'Event')); ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="flex flex-wrap items-center gap-3">
                                    ...
                                    <a href="#!" class="relative flex items-center justify-center w-10 h-10 rounded-full bg-custom-100 text-custom-500 dark:bg-custom-500/20">
                                        5+
                                    </a>
                                </div>
                            </div>
