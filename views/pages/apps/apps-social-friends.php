...
<head>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Friends')); ?>
    ...
    <?php include 'partials/menu.php'; ?>
        ...
        <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
            ...
            <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Social Media', 'title' => 'Friends')); ?>
