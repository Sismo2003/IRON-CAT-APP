...
<head>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Forms Validation')); ?>
    ...
    <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
        ...
        <?php include 'partials/page-wrapper.php'; ?>
            ...
            <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Forms', 'title' => 'Forms Validation')); ?>
                        ...
                        <div class="mx-auto md:max-w-lg">
                            <form action="#!" id="signUp">
                                ...
                                <div class="mb-4">
                                    ...
                                    <label for="termsCondition" class="text-sm align-top text-slate-400">By registering you agree to the Tailwick <a href="#!" class="underline text-custom-500">Terms of Use</a></label>
